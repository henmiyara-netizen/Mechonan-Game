...
### 8. סטטוס שאלות
מסד ראשוני מסריקות חוברות תרגול שלב ב' של המשתמש (כיתה ב').
...
**שמירה על פרטיות**: אין להזכיר שמות מסחריים של חוברות הלימוד או מכונים בקוד / בממשק / ב-README — רק "חוברות תרגול שלב ב'" כמקור גנרי.
